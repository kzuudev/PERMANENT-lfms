              ...
              <table class="table-fixed w-full border-collapse border border-gray-300">
                ...
                <tbody>
                    <tr class="text-center">
                        <td class="p-2 border">{{ $request->reporter_name }}</td>
                        <td class="p-2 border">{{ $request->item_name }}</td>
                        <td class="p-2 border">{{ $request->selected_category }}</td>
                        <td class="p-2 border text-yellow-500 font-semibold">{{ $request->status }}</td>
                        <td class="p-2 border"><a class="text-[12px] px-4 py-1 bg-gray-200 rounded" href="{{ route('manage-items', ['id' => $request->id]) }}">View</a></td>
                    </tr>
                </tbody>
                @endforeach
